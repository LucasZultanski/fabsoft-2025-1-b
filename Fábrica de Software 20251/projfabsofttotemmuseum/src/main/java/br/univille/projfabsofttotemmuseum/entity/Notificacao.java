...
public class Notificacao {
    ...
    @Column(nullable = false)
    private String descricao; // Descrição da notificação

    @Column(nullable = false)
    private String tipo; // Tipo da notificação: "Evento" ou "Exposicao"
    ...
    private Evento evento; // Relacionamento com Evento (opcional)

    @ManyToOne
    @JoinColumn(name = "exposicao_id", nullable = true)
    private Exposicao exposicao; // Relacionamento com Exposicao (opcional)
